...
// console.log(counting.value() === 3); // 3

// counting.decrement();

// counting.decrement();

// console.log(counting.value() === 1); // 1

// console.log(counting.value(100) === 100); // 100

// counting.decrement();

// console.log(counting.value() === 99); // 99

// console.log(counting.value(200) === 200); // 200

// counting.increment();

// console.log(counting.value() === 201); // 201
...
let car = {
  ...
  name: 'Ford ',
  year: 2017,
  get used() { return (yearNow > this.year) ? 'used' : 'new' },
  set used(value) {
